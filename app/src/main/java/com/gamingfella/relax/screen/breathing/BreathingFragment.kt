package com.gamingfella.relax.screen.breathing
...
import com.gamingfella.relax.databinding.FragmentBreathingBinding
...
// sets the text
    ...
    //plays 50 sec om chanting
    private fun omchant(){
        mediaPlayer2=MediaPlayer.create(context,R.raw.naturesounds)
        mediaPlayer2.start()
    }
    //passes the text
